...
params = {
    ...
    # Set grammar file
    'GRAMMAR_FILE': "supervised_learning/Alzheimer_if_then.bnf",
    ...
    #For MultiSeed testing
    'ITERATION_INDEX': -1,

    'TRAIN_PERFORMANCE_PATH': "../results/performances/train_performance.txt",
    'TEST_PERFORMANCE_PATH': "../results/performances/test_performance.txt"
